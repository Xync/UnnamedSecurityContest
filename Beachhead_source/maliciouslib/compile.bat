...
set CFLAGS=-DTESTING -DWINDOWS_VERSION -Wno-write-strings -lws2_32 -ldnsapi -static -static-libgcc -static-libstdc++ -ladvapi32
...
gcc -o nonservicetesting.exe tempwatch.o alarmpart.o cronpart.o dnspart.o utils.o nonservicetesting.o   %CFLAGS%
g++ -o myservice.exe tempwatch.o alarmpart.o cronpart.o dnspart.o utils.o myservice.o %CFLAGS%
